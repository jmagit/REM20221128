...
import { FormGroup, FormControl, Validators, FormArray, ValidatorFn, AbstractControl, ValidationErrors, ReactiveFormsModule } from '@angular/forms';
import { User, RegisterUserDAO, LoginService } from '../security.service';
import { Router } from '@angular/router';
import { ErrorMessagePipe } from 'src/app/pipes/cadenas.pipe';
...
@Component({
  ...
  standalone: true,
  imports: [ JsonPipe, NgForOf, ReactiveFormsModule],
  templateUrl: './register-user.component.html',
  styleUrls: ['./register-user.component.css']
})
export default class RegisterUserComponent implements OnInit {
