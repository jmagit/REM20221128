...
import { ToComaDecimalPipe } from 'src/app/pipes';
import { LoggerService, NotificationService, NotificationType } from 'src/app/services';

@Component({
  selector: 'calculadora',
  standalone: true,
  imports: [ToComaDecimalPipe, NgIf, SlicePipe],
